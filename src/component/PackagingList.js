...
import {clearList} from "../action/action"
...
//     console.log("Global Store State in Packaging List =>",globalstorestate)
...
//                         return <Item item={element} deleteHandle={deleteHandle} onToogleItem={onToogleItem} key={indx} />
//                     })
//                 }
...
function PackingList() {
    ...
    return (
        <div className="list">
            <ul>
                {
                    globalstorestate.items.map((element,indx)=>{
                        return <Item item={element} key={indx}/>
                    })
                }
            </ul>
            <div className="buttons">
